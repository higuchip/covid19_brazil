...
p<-p + annotate(geom = "text", x = 0, y = 600, label = label.text,
...
p+annotate(geom = "curve", x = 19, y = 300, xend = 19, yend = 200, 
  curvature = 0, arrow = arrow(length = unit(2, "mm"))) +
  annotate(geom = "text", x = 18, y = 315, label = "Hoje", hjust = "left", cex=6)
